      ...
      <div className="grid grid-cols-12 gap-6 md:gap-stack-lg max-w-7xl mx-auto">
        ...
        <div className="col-span-12 glass-card rounded-xl p-container-padding flex flex-col md:flex-row md:items-center justify-between relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-stack-sm md:w-1/2">
            <h2 className="font-label-sm text-label-sm text-slate-400 uppercase tracking-widest">Total Aset</h2>
            ...
            <div className="inline-flex items-center bg-emerald-500/10 px-3 py-1.5 rounded-full border border-emerald-500/20 mt-2">
              <span className="font-data-mono text-data-mono text-emerald-400 flex items-center gap-1">
          ...
          <div className="relative z-10 mt-stack-lg md:mt-0 flex flex-col items-end md:w-1/2">
            <div className="flex gap-8 mb-6 w-full justify-start md:justify-end">
              <div className="border-l-2 border-emerald-500/30 pl-3">
                <p className="font-label-sm text-label-sm text-slate-400">24 Jam</p>
                <p className="font-data-mono text-data-mono text-slate-200 text-lg">+1.2%</p>
              </div>
              <div className="border-l-2 border-emerald-500/30 pl-3">
                <p className="font-label-sm text-label-sm text-slate-400">7 Hari</p>
                <p className="font-data-mono text-data-mono text-slate-200 text-lg">+3.45%</p>
              </div>
              <div className="border-l-2 border-emerald-500/30 pl-3">
                <p className="font-label-sm text-label-sm text-slate-400">30 Hari</p>
        ...
        <div 
          ...
          className="col-span-12 md:col-span-4 glass-card rounded-2xl p-6 relative overflow-hidden cursor-pointer border border-white/5 hover:border-emerald-500/30 transition-all duration-500 group shadow-[0_8px_30px_rgba(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgba(16,185,129,0.15)] bg-gradient-to-b from-white/[0.02] to-transparent"
        >
          {/* Decorative Glow */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2 group-hover:bg-emerald-500/20 transition-colors duration-700 pointer-events-none"></div>
          
          <div className="flex items-start justify-between mb-8 relative z-10">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-emerald-500/5 flex items-center justify-center border border-emerald-500/20 group-hover:scale-110 transition-transform duration-500 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
          ...
          <div className="relative z-10">
            <h3 className="font-medium text-[11px] text-slate-400 mb-1.5 uppercase tracking-[0.15em]">Total Investasi</h3>
          ...
          <div className="relative z-10">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-xs text-emerald-400 font-bold">{getPercentage(totalInvestasi)}%</span>
            </div>
            <div className="h-1.5 w-full bg-slate-900/80 rounded-full overflow-hidden shadow-inner">
              <div 
                className="h-full bg-emerald-500 rounded-full transition-all duration-1000 relative shadow-[0_0_10px_rgba(16,185,129,0.5)]" 
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="font-medium text-[11px] text-slate-400 mb-1.5 uppercase tracking-[0.15em]">Total Tabungan</h3>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="font-medium text-[11px] text-slate-400 mb-1.5 uppercase tracking-[0.15em]">Operasional</h3>
        ...
        {/* Active Chart Area */}
        <div className="col-span-12 glass-card rounded-xl p-container-padding h-96 flex flex-col relative overflow-hidden">
              ...
              {['1W', '1M', '1Y'].map(tf => (
                <button 
                  ...
                  className={`px-3 py-1 rounded text-sm transition-colors ${
                    timeframe === tf 
                      ? 'bg-emerald-500 text-on-primary font-medium' 
